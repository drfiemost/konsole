...
void ProfileTest::testProfileGroup()
{
    ...
    QVERIFY(profile[1]->property<QString>(Profile::Name) != QStringLiteral("NewName"));
    QVERIFY(profile[2]->property<QString>(Profile::Path) != QStringLiteral("NewPath"));
    ...
    group->setProperty(Profile::Command, QLatin1String("fish"));
