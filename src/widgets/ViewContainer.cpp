    ...
    , _contextMenuTabIndex(0)
{
    ...
    _contextPopupMenu->addAction(KIcon(QStringLiteral("tab-detach")),
                                 i18nc("@action:inmenu", "&Detach Tab"), this,
                                 SLOT(tabContextMenuDetachTab()));
#endif

    _contextPopupMenu->addAction(KIcon(QStringLiteral("edit-rename")),
                                 i18nc("@action:inmenu", "&Rename Tab..."), this,
                                 SLOT(tabContextMenuRenameTab()));

    _contextPopupMenu->addSeparator();

    _contextPopupMenu->addAction(KIcon(QStringLiteral("tab-close")),
    ...
    _newTabButton->setIcon(KIcon(QStringLiteral("tab-new")));
    ...
    _closeTabButton->setIcon(KIcon(QStringLiteral("tab-close")));
