...
void ViewManager::updateDetachViewState()
{
    ...
    const bool shouldEnable = splitView || (activeContainer && activeContainer->count() >= 2);
...
void ViewManager::splitView(Qt::Orientation orientation)
{
    ...
    QWidget* activeView = activeContainer ? activeContainer->currentWidget() : nullptr;
...
void ViewManager::closeOtherContainers()
{
    ...
    for(TabbedViewContainer* container: _viewSplitter->containers()) {
        if (container != active)
            removeContainer(container);
    }
}
...
TabbedViewContainer* ViewManager::createContainer()
{
    ...
    connect(container, static_cast<void(TabbedViewContainer::*)()>(&Konsole::TabbedViewContainer::newViewRequest), this, static_cast<void(ViewManager::*)()>(&Konsole::ViewManager::newViewRequest));
    connect(container, static_cast<void(TabbedViewContainer::*)(Profile::Ptr)>(&Konsole::TabbedViewContainer::newViewRequest), this, static_cast<void(ViewManager::*)(Profile::Ptr)>(&Konsole::ViewManager::newViewRequest));
    connect(container, &Konsole::TabbedViewContainer::moveViewRequest,
            this , &Konsole::ViewManager::containerMoveViewRequest);
    connect(container , &Konsole::TabbedViewContainer::viewRemoved , this , &Konsole::ViewManager::viewDestroyed);
    connect(container , &Konsole::TabbedViewContainer::activeViewChanged , this , &Konsole::ViewManager::viewActivated);
